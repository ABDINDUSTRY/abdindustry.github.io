...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setSorbonneLogo('sorbonne_logo.png');
    setTSLogo('triomphe_logo.webp');
    setAWSLogo('aws_logo.png')
    setSYSLogo('sys_logo.jpg')
    setAnssiLogo('anssi_logo.png');
    setSSTLogo('sst_logo.png');
    setThmLogo('thm_logo.png');
    setPhoto('abd.jpeg');
...
function setSorbonneLogo(imagePath) {
    // On récupère TOUS les logos Sorbonne
    const logoElements = document.querySelectorAll('.logo-placeholder.sorbonne');
    
    if (logoElements.length > 0 && imagePath) {
...
function setTSLogo(imagePath) {
    const logoElement = document.querySelector('.logo-placeholder.ts');
    if (logoElement && imagePath) {
        logoElement.style.backgroundImage = `url(${imagePath})`;
    }
}

function setSYSLogo(imagePath) {
    const logoElement = document.querySelector('.logo-placeholder.sys');
    if (logoElement && imagePath) {
        logoElement.style.backgroundImage = `url(${imagePath})`;
    }
}

function setAWSLogo(imagePath) {
    const logoElement = document.querySelector('.logo-placeholder.aws');
    if (logoElement && imagePath) {
        logoElement.style.backgroundImage = `url(${imagePath})`;
    }
}

function setAnssiLogo(imagePath) {
    const logoElement = document.querySelector('.logo-placeholder-small.anssi');
    if (logoElement && imagePath) {
        logoElement.style.backgroundImage = `url(${imagePath})`;
    }
}

function setSSTLogo(imagePath) {
    const logoElement = document.querySelector('.logo-placeholder-small.sst');
    if (logoElement && imagePath) {
        logoElement.style.backgroundImage = `url(${imagePath})`;
    }
}

function setThmLogo(imagePath) {
    const logoElement = document.querySelector('.logo-placeholder-small.thm');
    if (logoElement && imagePath) {
        logoElement.style.backgroundImage = `url(${imagePath})`;
    }
}
